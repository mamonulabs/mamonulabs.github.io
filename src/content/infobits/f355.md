...
The F355 packs two LFOs into a compact 2FU module, each capable of generating over 10,000 distinct waveforms through a sophisticated morphing algorithm. The rate range spans from glacially slow modulation—one cycle every 12 minutes—to audio-rate frequencies up to 1000Hz. At the heart of the module sits a 24 MHz 32-bit ARM processor, ensuring rock-solid stability with virtually no frequency drift.
...
The F355 shares its morphing engine with the acclaimed E350 Morphing Terrarium. Rather than abruptly switching between waveforms, the module calculates 4096 intermediate waves, creating seamless transitions from one stored wavetable to the next.
